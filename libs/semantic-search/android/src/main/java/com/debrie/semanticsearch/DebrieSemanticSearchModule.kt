package com.debrie.semanticsearch
...
class DebrieSemanticSearchModule(reactContext: ReactApplicationContext) :
    ReactContextBaseJavaModule(reactContext) {

    companion object {
        const val NAME = "DebrieSemanticSearch"
    ...
    private fun checkAndDownloadModel() {
        ...
        scope.launch {
            try {
                // TODO: Integrate with @debrie/core model download
